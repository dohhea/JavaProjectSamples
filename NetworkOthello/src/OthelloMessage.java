...
public class OthelloMessage implements Serializable {
	// 메시지 타입 정의
	...
	public OthelloMessage() {
		this(MsgType.NO_ACT, "", "", "");
	}
	public OthelloMessage(MsgType t, String sID, String rID, String mesg) {
		type = t;
		sender = sID;
		receiver = rID;
		contents = mesg;
	}
	public OthelloMessage(MsgType t, int i, int j){
		type = t;
		this.i=i;
		this.j=j;
	}
	public OthelloMessage(MsgType t, boolean uk){
		type = t;
		userCheck = uk;
	}
